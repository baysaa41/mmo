...
urlpatterns = ([
    ...
    # Spam-с сэргийлэх (reCAPTCHA v3 + rate-limit) бүртгэлийн view-гээр
    # django-registration-ийн стандарт 'register/' URL-ыг override хийнэ.
    path('accounts/register/', RegistrationViewWithCaptcha.as_view(), name='django_registration_register'),
    ...
    path('api/provinces/', olympiad_api.list_provinces, name='api_provinces'),
