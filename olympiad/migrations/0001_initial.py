# Generated by Django 3.1.6 on 2022-01-20 14:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_message', models.TextField(default='Бодлогууд таалагдсан гэдэгт итгэлтэй байна.\n        Цаашид улам хичээн суралцаарай!')),
            ...
            options={
                'ordering': ['-school_year_id', 'round', 'level', 'id'],
            },
        ),
        migrations.CreateModel(
            name='Problem',
            fields=[
                ...
                ('numerical_answer', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.IntegerField(choices=[(0, 'Хариулаагүй'), (1, 'Засагдаагүй'), (2, 'Дүгнэгдсэн'), (3, 'Маргаантай'), (4, 'Зөвшөөрөгдсөн'), (5, 'Батлагдсан')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('olympiad', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='olympiad', to='olympiad.olympiad')),
                ('province', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='province', to='accounts.province')),
            ],
        ),
        migrations.CreateModel(
            name='Solution',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('place', models.CharField(choices=[('Алт', 'Алтан медаль'), ('Мөнгө', 'Мөнгөн медаль'), ('Хүрэл', 'Хүрэл медаль'), ('Тусгай', 'Тусгай шагнал'), ('Уран бодолт', 'Уран бодолт'), ('II шат', 'II шат')], default='Алт', max_length=20)),
