# Generated by Django 4.1.6 on 2025-02-10 00:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('s1', models.IntegerField(blank=True, default=0, null=True)),
                ('s2', models.IntegerField(blank=True, default=0, null=True)),
                ('s3', models.IntegerField(blank=True, default=0, null=True)),
                ('s4', models.IntegerField(blank=True, default=0, null=True)),
                ('s5', models.IntegerField(blank=True, default=0, null=True)),
                ('s6', models.IntegerField(blank=True, default=0, null=True)),
                ('s7', models.IntegerField(blank=True, default=0, null=True)),
                ('s8', models.IntegerField(blank=True, default=0, null=True)),
                ('s9', models.IntegerField(blank=True, default=0, null=True)),
                ('s10', models.IntegerField(blank=True, default=0, null=True)),
                ('s11', models.IntegerField(blank=True, default=0, null=True)),
                ('s12', models.IntegerField(blank=True, default=0, null=True)),
                ('s13', models.IntegerField(blank=True, default=0, null=True)),
                ('s14', models.IntegerField(blank=True, default=0, null=True)),
                ('s15', models.IntegerField(blank=True, default=0, null=True)),
                ('s16', models.IntegerField(blank=True, default=0, null=True)),
                ('s17', models.IntegerField(blank=True, default=0, null=True)),
                ('s18', models.IntegerField(blank=True, default=0, null=True)),
                ('s19', models.IntegerField(blank=True, default=0, null=True)),
                ('s20', models.IntegerField(blank=True, default=0, null=True)),
