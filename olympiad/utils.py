...
def copy_ulsiin_erh():
    ...
    for score_sheet in score_sheets:
        if score_sheet.olympiad_id == 170:
            ScoreSheet.objects.filter(olympiad_id=177,user_id=score_sheet.user_id).update(prizes='Улсын эрхтэй')
        elif score_sheet.olympiad_id == 171:
            ScoreSheet.objects.filter(olympiad_id=178,user_id=score_sheet.user_id).update(prizes='Улсын эрхтэй')
        elif score_sheet.olympiad_id == 173:
            ScoreSheet.objects.filter(olympiad_id=180,user_id=score_sheet.user_id).update(prizes='Улсын эрхтэй')
