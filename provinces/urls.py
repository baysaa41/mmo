...
urlpatterns = [
    ...
    path('<int:province_id>/olympiad/<int:olympiad_id>/select-teachers/',
         views.select_teachers, name='select_teachers'),
    path('<int:province_id>/olympiad/<int:olympiad_id>/merge-teacher-list/',
         views.merge_teacher_list, name='merge_teacher_list'),
    path('<int:province_id>/olympiad/<int:olympiad_id>/request-teacher-merge/',
         views.request_teacher_merge, name='request_teacher_merge'),
    path('<int:province_id>/olympiad/<int:olympiad_id>/merge-teachers/',
         views.merge_teachers, name='merge_teachers'),
